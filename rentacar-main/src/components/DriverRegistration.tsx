    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Log in the user
                const signInResponse = await fetch(`${process.env.REACT_APP_API_URL}/api/auth`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                if (signInResponse.ok) {
                    ...
                    const isDriver = decodedToken.isDriver !== undefined ? decodedToken.isDriver : false;
                    setLoggedIn(true, isAdmin, isDriver, decodedToken.id);
    ...
    return (
        <div>
            <div className="container h-screen mx-auto mt-20 my-8">
                <Header />
                <h2 className="text-3xl text-center mb-4">Register As A driver</h2>
