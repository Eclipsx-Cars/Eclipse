...
import { Car } from './RentalCarsPage';
                ...
                <tbody>
                    {cars.map((car) => (
                        <tr className="bg-gray-600 text-gray-300" key={car.id}>
                            ...
                            <td className="border px-4 py-2">{car.CarForReason}</td>
                            ...
                            <td className="border px-4 py-2">
                                {car.imageUrl ? (
                                    <img className=" w-1/4 h-1/4" src={`${process.env.REACT_APP_API_URL}${car.imageUrl}`} alt={`${car.make} ${car.model}`} />
                                ) : (
